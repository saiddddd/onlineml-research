...
YEAR_OF_DATA = '2021'
READ_FILE_NAME = '../../data/append_raw_data/HighwayTrafficData_RawDataAppended_' + YEAR_OF_DATA +'.csv'
SAVE_FILE_NAME = '../../data/eda_data/highway_traffic_eda_data_ready_for_ml_{}_09.csv'.format(YEAR_OF_DATA)

# %%
'''ingress data from aggregated raw append with gantry infomations'''
df_etc_traffic = pd.read_csv(READ_FILE_NAME, parse_dates=['DateTime'])
# %%
df_etc_traffic
#%%
...
df1 = df_etc_traffic[
    (df_etc_traffic['DateTime']>='2021/09/01 00:00') &
    (df_etc_traffic['DateTime']<'2021/10/01 00:00')
    ]
...
def dataframe_transformer(df):
    ...
    #==============================#
    df['TrafficJam'] = (df['MeanSpeed']<70) & (df['Traffic'] > 10)
...
df1['TrafficJam60MinLater'] = df1.groupby(['國道別', 'GantryID', 'GantryTo'])['TrafficJam'].shift(-12)
df1['TrafficJam60MinLater'] = df1['TrafficJam60MinLater'].fillna(False)
df1['TrafficJam60MinLater'] = df1['TrafficJam60MinLater'].astype(int)
...
# %%
# df1.columns
df1_save = df1[['DateTime', '國道別', '方向', 'ICNUM', '里程', '起點交流道', '迄點交流道',
               ...
               'TrafficJam', 'TrafficJam30MinLater', 'TrafficJam60MinLater'
               ]]
df1_save.to_csv(SAVE_FILE_NAME, index=False)

#%%
print('Successfully save eda data.')

# #%%
#=================#
# Data validation #
#=================#
# df1_save[(df1_save['TrafficJam'] == True) & (df1_save['DateTime'] >= '2021-02-01 08:00:00')][['DateTime', '起點交流道', '迄點交流道', 'Traffic', 'MeanSpeed', 'TrafficJam']]


# #%%
# df1_save[(df1_save['DateTime'] == '2021-02-01 07:00:00') & (df1_save['起點交流道'] == '大灣') & (df1_save['迄點交流道'] == '永康')][['DateTime', '起點交流道', '迄點交流道', 'Traffic', 'MeanSpeed', 'TrafficJam', 'TrafficJam60MinLater']]
